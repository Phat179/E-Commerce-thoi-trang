                            ...
                            <div class="tab-pane fade active show" id="account-general">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="Nguyễn Thế Phát">
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label">E-mail</label>
                                        <input type="text" class="form-control mb-1" value="thephat1709@mail.com">
                                ...
                                <div class="card-body pb-2">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control"
                                            rows="5" >Sinh viên CNTT Phenikaa 
From Hanoi, Vietnam </textarea>
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label">Birthday</label>
                                        <input type="text" class="form-control" value="September 17, 2002">
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="card-body pb-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="0984663477">
                                    </div>
                                    <div class="form-group">
                            ...
                            <div class="tab-pane fade" id="account-social-links">
                                <div class="card-body pb-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="https://www.facebook.com/profile.php?id=100012341737740">
                                    </div>
                                    <div class="form-group">
    ...
    <footer class="section-p1">
        ...
        <div class="col install">
            ...
            <div class="row">
                <a href=""><img src="assets/image/app.jpg" alt=""></a>
                <a href=""><img src="assets/image/play.jpg" alt=""></a>
